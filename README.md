...
One last thing to note: I've been using .nsp and .htm files as Perl on my servers for a very long time, over a decade and a half. NSP is a Netmedia Solutions Program and NSF is Netmedia Solutions File, the latter of which is a flat data file. Side note: Netmedia Solutions was my old company name. To run .htm and .nsp programs simply set up you server configuration to handle those extensions as Perl programs.
