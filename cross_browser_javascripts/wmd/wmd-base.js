...
_2b.height="100%";
_2b.width=_2a;
_2b.filter="progid:DXImageTransform.Microsoft."+"AlphaImageLoader(src='"+_2.basePath+"cross_browser_javascripts/wmd/images/bg.png')";
_2b.position="absolute";
if(_2e&1){
_2b.top="0";
}else{
...
_2b.height="100%";
_2b.width=_2a;
_2b.filter="progid:DXImageTransform.Microsoft."+"AlphaImageLoader(src='"+_2.basePath+"cross_browser_javascripts/wmd/images/bg-fill.png',sizingMethod='scale')";
_2b.position="absolute";
_33.appendChild(_34);
if(_32){
_2b.left="0";
...
if(!_2c){
_2b.backgroundImage="url("+_2.basePath+"cross_browser_javascripts/wmd/images/bg-fill.png)";
...
var _d0=function(){
var _d1=_6.createImage("cross_browser_javascripts/wmd/images/separator.png",20,20);
...
_e1();
_6.skin(_b8,_2.basePath+"cross_browser_javascripts/wmd/images/bg.png",_b2,_b3);
...
_b8.appendChild(_b9);
_cd(_8.autoindent);
var _e8=_6.createImage("cross_browser_javascripts/wmd/images/bg.png");
var _e9=_6.createImage("cross_browser_javascripts/wmd/images/bg-fill.png");
_e2();
_d9();
if(_bd){
_d0();
...
var _fc=_6.createImage("cross_browser_javascripts/wmd/images/wmd.png");
var _fd=_6.createImage("cross_browser_javascripts/wmd/images/wmd-on.png");
_fb.appendChild(_fc);
_fb.onmouseover=function(){
_6.setImage(_fc,"cross_browser_javascripts/wmd/images/wmd-on.png");
_fb.style.cursor="pointer";
};
_fb.onmouseout=function(){
_6.setImage(_fc,"cross_browser_javascripts/wmd/images/wmd.png");
};
_b8.appendChild(_fb);
};
var _e1=function(){
...
if(_152){
_154=_6.prompt("<p style='margin-top: 0px'><b>Enter the image URL.</b></p><p>You can also add a title, which will be displayed as a tool tip.</p><p>Example:<br />http://wmd-editor.com/cross_browser_javascripts/wmd/images/cloud1.jpg   \"Optional title\"</p>","http://",_155);
}else{
...
_8.bold.image="cross_browser_javascripts/wmd/images/bold.png";
_8.bold.key="b";
_8.bold.textOp=_8.doBold;
_8.italic={};
_8.italic.description="Emphasis <em>";
_8.italic.image="cross_browser_javascripts/wmd/images/italic.png";
_8.italic.key="i";
_8.italic.textOp=_8.doItalic;
_8.link={};
_8.link.description="Hyperlink <a>";
_8.link.image="cross_browser_javascripts/wmd/images/link.png";
_8.link.key="l";
...
_8.undo.image="cross_browser_javascripts/wmd/images/undo.png";
_8.undo.execute=function(_15b){
_15b.undo();
};
_8.redo={};
_8.redo.description="Redo";
_8.redo.image="cross_browser_javascripts/wmd/images/redo.png";
