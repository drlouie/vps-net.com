...
function layerWrite(txt) {
	txt = '<table border="0" cellpadding="0" cellspacing="0"><tr><td id="overDiv-bg-ne"></td><td id="overDiv-bg-n"></td><td id="overDiv-bg-nw"></td></tr><tr><td id="overDiv-bg-e"></td><td id="overDiv-bg-color">' + txt + '</td><td id="overDiv-bg-w"></td></tr><tr><td id="overDiv-bg-se"></td><td id="overDiv-bg-s"></td><td id="overDiv-bg-sw"></td></tr></table>';
	txt += "\n";
	if (olNs4) {
